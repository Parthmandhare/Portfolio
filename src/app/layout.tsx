...
export const metadata: Metadata = {
  title: "Parth Mandhare",
  description:
    "Check out modern and stylish porfolio of an experienced Web Developer Parth Mandhare! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.",
};
